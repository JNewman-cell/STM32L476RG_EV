...
void RTC_Init(void) {
	...
	RTC_Set_Calendar_Date(RTC_WEEKDAY_WEDNESDAY, 22, RTC_MONTH_MARCH, 23); /* [TODO] These values are stubs - fill in current date */
	
	// Configure the Time 
	RTC_Set_Time(RTC_TR_PM, 9, 25, 0); /* [TODO] These values are stubs - fill in current time */
